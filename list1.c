...
/**
 * list_len - Provides the length of the linked list
 ...
 * @c: The next character after the prefix to match the list
 *
 * Return: Match node or null n error
 */
...
/**
 * get_node_index - Collects the index of the node
